...
Procedure Mapping: It maps the services codes to their respective functions and
...
from feature_message_encode.feature import message_encode
from feature_message_decode.feature import message_decode
